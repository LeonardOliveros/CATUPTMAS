...
class MYPDF extends TCPDF {
    public function Header() {
        ...
        $this->Cell(0, 4, reporteController::$socio, false, true, 'L');
        $this->Cell(0, 4, reporteController::$fechas, false, true, 'R');
...
<<< EOT
    <table bgcolor="#ffffff" border="1" cellpadding="2" cellspacing="1" width="100%">
        <tr>
            ...
            <td width="30%" height="13" style="text-align: center">
            <font><strong>Socio</strong></font></td>
            <td width="15%" height="13" style="text-align: center">
            <font><strong>Referencia</strong></font></td>
            <td width="15%" height="13" style="text-align: center">
            <font><strong>Tipo de Movimiento</strong></font></td>
            <td width="15%" height="13" style="text-align: center">
            <font><strong>(-) DEBE</strong></font></td>
            <td width="15%" height="13" style="text-align: center">
            <font><strong>(+) HABER</strong></font></td>
        </tr>
    </table>
EOT;
...
foreach ($listado AS $l){
    ...
    $e = explode(' - ', $l['tipo_mov']);
    if ($l['estado_mov'] == 'Aceptado' && $e[0] == 'Retiro') {
        $var.= '
        <tr>
            <td width="10%" height="13" style="text-align: center">' . $view->Fecha($l['fecha_mov']);
            $var.= '</td>
            <td width="30%" height="13" style="text-align: left">' . $view->Cedula($l['cedula_rif_soc']) . ' - ' . $l['apellidos_soc'] . ' ' . $l['nombres_soc'];
            $var.= '</td>
            <td width="15%" height="13" style="text-align: center">' . $l['referencia_mov'];
            $var.= '</td>
            <td width="15%" height="13" style="text-align: center">' . $l['tipo_mov'];
            $var.= '</td>
