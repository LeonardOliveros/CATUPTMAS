...
class MYPDF extends TCPDF {
    public function Header() {
        ...
        $this->Cell(20, 10, '', false, false, 'L');
        $this->Cell(60, 4, reporteController::$titulo, false, false, 'L');
...
foreach ($listado AS $l){
    ...
    if ($l['estado_mov'] == 'Aceptado' && $e[0] == 'Retiro') {
        $var.= '
        <tr>
            <td width="20%" height="13" style="text-align: center">' . $view->Fecha($l['fecha_mov']);
            $var.= '</td>
            <td width="20%" height="13" style="text-align: center">' . $l['referencia_mov'];
            $var.= '</td>
            <td width="20%" height="13" style="text-align: center">' . $l['tipo_mov'];
            $var.= '</td>
            <td width="20%" height="13" style="text-align: center">' . $view->Dinero($l['monto_mov']);
            $var.= '</td>
            <td width="20%" height="13" style="text-align: center">';
            $var.= '</td></tr>';
    } else {
