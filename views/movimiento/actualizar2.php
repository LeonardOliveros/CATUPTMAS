        ...
        <div id="departamento" class="form-group">
          ...
          <div class="col-sm-9">
            <select name="departamento" class="form-control">
              ...
              <option value="<?= $departamento['id_dep']?>" <?php if (isset($this->form['departamento']) && $this->form['departamento'] == $departamento['id_dep']):?>selected<?php endif;?>><?= $departamento['nombre_dep']?></option>
              <?php endforeach;?>
            </select>
          </div>
        </div>
