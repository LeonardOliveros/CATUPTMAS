        ...
        <div class="col-md-6 col-md-offset-3">
            <form class="form-horizontal adminex-form" method="post">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-9">
                        <input type="text" class="form-control" id="nombre_pla_pre" name="nombre_pla_pre" placeholder="Nombre del Plazo del Prestamo" value="<?php if (isset($this->datos["nombre_pla_pre"])): echo $this->datos["nombre_pla_pre"]; endif;?>">
                    </div>
                </div>
                <div class="form-group">
