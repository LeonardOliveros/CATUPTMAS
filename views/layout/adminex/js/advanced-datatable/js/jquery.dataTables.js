...
(/** @lends <global> */function( $ ) {
	...
	var DataTable = function( oInit )
	{
		...
		this.$ = function ( sSelector, oOpts )
		{
			...
			{
				_fnLog( oSettings, 1, "Opciones de selección desconocidos" );
			}
		...
		this.each(function() {
			...
			{
				_fnLog( null, 0, "Intento de inicializar tablas de datos en un nodo que no es una "+
					"tabla: "+this.nodeName );
				return;
			}
				...
				if ( DataTable.settings[i].nTable == this )
				{
					...
					else
					{
						_fnLog( DataTable.settings[i], 0, "No se puede reinicializar DataTable.\n\n"+
							"Para recuperar el objeto de tablas de datos para esta tabla, no pasa argumentos o ver "+
							"la documentación para bRetrieve y bDestroy" );
						return;
					}
				}
